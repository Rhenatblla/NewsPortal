    ...
    <>
          ...
          {user ? (
            <>
              ...
              <div className="user-dropdown">
                <button className="dropdown-toggle" onClick={toggleDropdown} aria-haspopup="true" aria-expanded={showDropdown}>
                  <img src={user.profilePicture || defaultAvatar} alt={user.name} className="user-avatar" width="32" height="32" loading="lazy" />
      ...
      {showMenu && (
        <>
          ...
          <nav ref={menuRef} id="main-menu" className="hamburger-menu" role="navigation" aria-label="Main menu">
            ...
            <ul className="menu-list">
              <li>
                <Link to="/" onClick={closeMenu} className="menu-item" aria-current={location.pathname === "/" ? "page" : undefined}>
              ...
              {user && (
                <>
                  <li>
                    <Link to="/my-works" onClick={closeMenu} className="menu-item" aria-current={location.pathname === "/my-works" ? "page" : undefined}>
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <li>
                    <Link to="/bookmarks" onClick={closeMenu} className="menu-item" aria-current={location.pathname === "/bookmarks" ? "page" : undefined}>
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
              ...
              {!user && (
                <>
                  ...
                  <li>
                    <Link to="/register" onClick={closeMenu} className="menu-item">
                      <span>Register</span>
                    </Link>
                  </li>
                </>
